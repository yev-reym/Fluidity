...
//Create our capsule data type which will act as a particle. We use the capsule
//data structure because it makes collision detection easier when there is a
//line within the capsule to reference a point on. 
...
export const Capsule = function(pointA, pointB, radius, color) {
    this.pA = createVector(pointA[0], pointA[1]);
    this.pB = createVector(pointB[0], pointB[1]);
...
export const DepthChecker = function(capsule, x) {
