...
export const Capsule = function(pointA, pointB, radius, color) {
    this.pA = new p5.Vector(pointA[0] * constants.CONTAINER_SCALE, pointA[1] * constants.CONTAINER_SCALE);
    this.pB = new p5.Vector(pointB[0] * constants.CONTAINER_SCALE, pointB[1] * constants.CONTAINER_SCALEs);

    this.radius = radius * constants.CONTAINER_SCALE;
    this.color = color;
