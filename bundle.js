...
/* harmony import */ var _rendering_render_mesh__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rendering/render_mesh */ "./lib/rendering/render_mesh.js");
...
/***/ "./lib/rendering/render_mesh.js":
/*!**************************************!*\
  !*** ./lib/rendering/render_mesh.js ***!
  \**************************************/
/*! exports provided: cartToPixel, SimMesh */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cartToPixel", function() { return cartToPixel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SimMesh", function() { return SimMesh; });
/* harmony import */ var gl_buffer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gl-buffer */ "./node_modules/gl-buffer/buffer.js");
/* harmony import */ var gl_buffer__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(gl_buffer__WEBPACK_IMPORTED_MODULE_0__);
...
class SimMesh {
    constructor(glContext, canvasWidth, canvasHeight){
        ...
        this.positionBufferObject = gl_buffer__WEBPACK_IMPORTED_MODULE_0___default()(this.glContext,[]);
        this.colorBufferObject = gl_buffer__WEBPACK_IMPORTED_MODULE_0___default()(this.glContext, []);
        this.textureBufferObject = gl_buffer__WEBPACK_IMPORTED_MODULE_0___default()(this.glContext, []);
        this.indexBufferObject = gl_buffer__WEBPACK_IMPORTED_MODULE_0___default()(this.glContext, [], this.glContext.ELEMENT_ARRAY_BUFFER);
    }
